...
trainframe = pd.read_csv(r'C:\Users\Qiu\Desktop\Shopee\training.csv')
user_profile = pd.read_csv(r'C:\Users\Qiu\Desktop\Shopee\user_profiles_MY.csv')
likes = pd.read_csv(r'C:\Users\Qiu\Desktop\Shopee\likes.csv')
vouchers = pd.read_csv(r'C:\Users\Qiu\Desktop\Shopee\Voucher_mechanics.csv')
activedate = pd.read_csv(r'C:\Users\Qiu\Desktop\Shopee\voucher_distribution_active_date.csv')
...
for lags in range(31):
    log_temp = view_log_read(r'C:\Users\Qiu\Desktop\Shopee\view_log_%d.csv' % lags, lags)
...
trans_log = pd.read_csv(r'C:\Users\Qiu\Desktop\Shopee\transactions_MY.csv')
...
traindata = trainframe3.drop(['userid', 'promotionid_received', 'voucher_code_received', 'voucher_received_date'],
                             axis=1)
